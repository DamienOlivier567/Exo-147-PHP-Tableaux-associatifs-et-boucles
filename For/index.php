...
$num = count($couleurs); // J'effectue le count en-dehors de la boucle for pour éviter que php ne doive recalculer à
// chaque itération le nombre d'éléments du tableau
for ($i = 0; $i < $num; ++$i) {
    echo $couleurs[$i] . "<br>";
}
echo "<br><br>";
